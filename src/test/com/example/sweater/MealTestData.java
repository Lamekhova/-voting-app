...
public class MealTestData {
    ...
    public static final List<Meal> PEPERONI_MEALS_TODAY = List.of(BURGER, EGG, EGGPLANT);
    public static final List<Meal> PERCHINI_MEALS_TODAY = List.of(TUNA, FOCACCIA, PIZZA);
}
